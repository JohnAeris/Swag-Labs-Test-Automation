...
public class TS_LEFT_MENU_NAVIGATION_04 {
	...
	void TC_LMN_00() throws InterruptedException {
		menuButton.click();
	...
	void TC_LMN_02() throws InterruptedException {
		menuButton.click();
	...
	void TC_LMN_03() throws InterruptedException {
		menuButton.click();
		driver.findElement(By.id("about_sidebar_link")).click();
		
		String expectedPage = "https://saucelabs.com/";
		String actualPage = driver.getCurrentUrl();
		System.out.println("Option Link: " + actualPage);
	...
	void TC_LMN_04() {
		...
		String actualPage = driver.getCurrentUrl();
		System.out.println("Logout Link: " + actualPage);
	...
	void TC_LMN_05() throws InterruptedException {	
		...
		String initialAppState = driver.findElement(By.className("shopping_cart_container")).getText();
		
		softAssert.assertNotSame(initialAppState, "4");
		softAssert.assertAll();
	}
